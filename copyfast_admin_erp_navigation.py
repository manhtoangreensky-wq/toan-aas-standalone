...
_MODULE_DESCRIPTIONS = {
    ...
    "postback_readiness": "Hướng dẫn chuẩn bị postback chỉ đọc; không hiển thị thông tin kết nối nhạy cảm, không gửi event, không đọc/gắn affiliate hoặc job và không ghi attribution, doanh thu hay payout.",
    ...
    return [
        ...
        _group(
            ...
            modules=[
                ...
                _directory_module("postback_readiness", "Postback Readiness Guide", "/admin/growth/postback-readiness"),
