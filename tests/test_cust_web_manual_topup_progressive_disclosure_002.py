...
def test_9_instruction_css_matches_the_markup_instead_of_dead_component_classes():
    ...
    assert (
        "grid-template-columns: minmax(360px, 420px) minmax(0, 1fr)" in desktop.group("body")
        or "grid-template-columns: minmax(0, 1fr) minmax(132px, 180px)" in desktop.group("body")
    )
