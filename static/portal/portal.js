...
(function portalShell() {
  ...
  function imageStudioArtboardValues(value) {
    ...
    return {
      ...
      creative_brief: String(source.creative_brief || source.brief_excerpt || ""), style_direction: String(source.style_direction || ""),
