...
| case variants, suffixes or unreviewed create_media\|quick_image / create_media\|qi_* spellings | QUICK_IMAGE_PLANNER_SOURCE_REVIEW_REQUIRED | quick_image_planner_callback_requires_exact_source_review | no Web route, Bot checkout disposition, browser state reset, provider/job/wallet/payment or delivery action |
