...
| Area | Bot | Web App |
| --- | --- | --- |
| Source files scanned | 172 | 124 |
| Noncanonical Bot drafts excluded | 4 | n/a |
| Commands | 773 | n/a |
| Callback handlers | 54 | n/a |
| Callback-data values | 1925 | n/a |
| Conversation handlers | 0 | n/a |
| FastAPI routes | 139 | 206 |
| Background/job signals | 194 | 7 |
| Database tables | 97 | 63 |
| Environment names | 364 | 90 |
