...
- Bot checkout observed for drift only: `3947e259f96547cd7fddb62e79a05306005dad23` (`ahead_of_requested_baseline`)
- Bot drift versus requested baseline: ahead `1307`, behind `0` commits
- Web source audit snapshot: `d0dd0a3601f709f78e4c702a45222bb6797b7c84`; requested revision `d0dd0a3601f709f78e4c702a45222bb6797b7c84` (`exact`); eligible-source worktree `clean`
- Bot source fingerprint: `93eb18b700f7c2b17331ef40b92994ae1ce071deb5ed486be9da22b513dc3841`
- Web source fingerprint: `067fbed7206dd8f3ecda3cc8aedf131a6d0a0043a2f7122acfb1e621daa2cf01`
...
- [`ADMIN_ERP_MENU_CALLBACK_CONTRACT.md`](ADMIN_ERP_MENU_CALLBACK_CONTRACT.md) — 28 exact Bot-admin category/status menu dispositions; each opens only a fresh canonical-admin Web read route and never transfers Bot snapshots, commands, provider/package/payment controls or runtime authority.
...
- [`MENU_ACTION_TERMINAL_CATALOG_CONTRACT.md`](MENU_ACTION_TERMINAL_CATALOG_CONTRACT.md) — 28 exact frozen-Bot menu callbacks and 11 observed templates are `TELEGRAM_ONLY` static source evidence, not browser actions or runtime parity.
...
- [`IMAGE_BACKGROUND_CLEANUP_WEB_NATIVE_CONTRACT.md`](IMAGE_BACKGROUND_CLEANUP_WEB_NATIVE_CONTRACT.md) — bounded edge-connected plain-background cleanup to a verified private transparent PNG; it is not Bot RemoveBG/Cutout, a provider call, a wallet/payment action or an `imgtool` callback adapter.
