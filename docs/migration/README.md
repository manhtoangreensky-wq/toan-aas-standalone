...
- Bot source audited: working-tree fallback `unavailable` (`not_a_git_worktree`)
- Web source audit snapshot: `7db7e3ffe8dd8deb055dd6418982c06414a70ea5`; requested revision `HEAD` (`requested_sha_invalid`); eligible-source worktree `clean`
- Bot source fingerprint: `1e16a0992bdee2657b122e845176080609b59556b7f2b1c91e017ccb1cac93e8`
- Web source fingerprint: `8ee0aa1942503e726bd267ba53109844285404a6d6a79d1603bc62122caa11b6`
...
- Noncanonical Bot draft files excluded from inventory: `620`
- Canonical authority remains the bot for Telegram identity, Xu ledger, PayOS, jobs, and provider state.

- Requested baseline private bridge source (`webapp_core_bridge.py`): `baseline_unavailable` (`present=None`).
