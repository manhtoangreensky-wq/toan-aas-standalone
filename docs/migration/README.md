...
- Web source fingerprint: `f4ebc2a67ac3f062339b250cc040d3e3139705c358a28223866d596f5e6645c1`
...
- [`AUDIO_ASSET_OPERATIONS_CONTRACT.md`](AUDIO_ASSET_OPERATIONS_CONTRACT.md) — bounded owner-scoped Asset Vault audio inspect, fixed MP3/M4A conversion and verified private attachment; no AI enhancement, Bot/provider/PayOS/wallet claim.
- [`VIDEO_FINISHING_LAB_CONTRACT.md`](VIDEO_FINISHING_LAB_CONTRACT.md) — bounded owner-scoped MP4 reframe and visual finishing with a signed Portal handoff; no Telegram draft, provider, Bot, wallet/Xu, PayOS, publishing or broad Video-menu claim.
- [`FRAME_VIDEO_LAB_CONTRACT.md`](FRAME_VIDEO_LAB_CONTRACT.md) — bounded owner-scoped image-sequence MP4 with a signed Portal handoff; no Bot/provider/PayOS/wallet/Xu, public preview or broad Video-menu claim.
...
- [`VIDEO_PREVIEW_PRIVATE_CONTRACT.md`](VIDEO_PREVIEW_PRIVATE_CONTRACT.md) — disabled-by-default, owner-scoped MP4/WebM Asset Vault inspection through an in-memory same-origin Blob; it is not Bot playback, a signed/public URL, provider, FFmpeg, job, wallet/Xu or PayOS flow.
