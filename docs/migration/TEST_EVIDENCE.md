...
| --- | --- | --- |
| Static audit | Pinned Python 3.11 `scripts/migration/audit_bot_to_web.py` against the frozen Git snapshot and current Web main | 773 canonical Bot commands, 2,862 callback-data values and 675 Web routes; 38.74% static Web surface coverage, 83.1% safe disposition coverage, and runtime equivalence is `NOT_STATICALLY_VERIFIABLE` (0%). |
