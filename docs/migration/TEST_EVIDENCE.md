...
| --- | --- | --- |
| Static audit | Pinned Python 3.11 `scripts/migration/audit_bot_to_web.py` against the frozen Git snapshot and current Web main | 773 canonical Bot commands, 2,862 callback-data values and 664 Web routes; 38.71% static Web surface coverage, 80.68% safe disposition coverage, and runtime equivalence is `NOT_STATICALLY_VERIFIABLE` (0%). |
