...
| --- | --- | --- |
| Static audit | Pinned Python 3.11 `scripts/migration/audit_bot_to_web.py` against the frozen Git snapshot and current Web source | 773 canonical Bot commands, 2,862 callback-data values and 767 Web routes; 38.69% static Web surface coverage, 83.91% safe disposition coverage, and runtime equivalence is `NOT_STATICALLY_VERIFIABLE` (0%). |
