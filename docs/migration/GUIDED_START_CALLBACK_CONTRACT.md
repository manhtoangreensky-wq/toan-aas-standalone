...
| menu\|guide_guided_video | TELEGRAM_ONLY | guided_video_menu_deferred_telegram_only | TELEGRAM_ONLY | BOT_GUIDE_SECTION_CONTEXT_NOT_REPLAYED, BOT_GUIDE_CHILD_CALLBACKS_NOT_REPLAYED, VIDEO_MENU_LAST, SOURCE_STATE_MACHINE_REQUIRED, NO_RUNTIME_CLAIM |
| menu\|guide_video_ai | TELEGRAM_ONLY | guided_video_menu_deferred_telegram_only | TELEGRAM_ONLY | BOT_GUIDE_SECTION_CONTEXT_NOT_REPLAYED, BOT_GUIDE_CHILD_CALLBACKS_NOT_REPLAYED, VIDEO_MENU_LAST, SOURCE_STATE_MACHINE_REQUIRED, NO_RUNTIME_CLAIM |
