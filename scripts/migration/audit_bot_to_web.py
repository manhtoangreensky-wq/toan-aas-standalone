...
def _render_docs(docs_dir: Path, preflight: dict[str, Any], bot: dict[str, Any], web: dict[str, Any], gap: dict[str, Any]) -> list[Path]:
    ...
    write(
        ...
        + "- [`PDF_OCR_CONTRACT.md`](PDF_OCR_CONTRACT.md) — opt-in bounded 2× local private PDF OCR with verified TXT delivery; no browser OCR, provider, Bot, job, wallet or payment execution.\n"
        + "- [`PDF_OCR_WORD_CONTRACT.md`](PDF_OCR_WORD_CONTRACT.md) — opt-in bounded 2× local scanned-PDF OCR to verified private DOCX; no browser OCR, provider, Bot, job, wallet or payment execution.\n"
