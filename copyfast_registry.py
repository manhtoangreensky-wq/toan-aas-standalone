...
CUSTOMER_FEATURES: tuple[WebFeature, ...] = (
    ...
    WebFeature("voice_clone", "Clone giọng", "voice", "/voice", input_hint="Mẫu âm thanh đã được phép sử dụng."),
    WebFeature("voice_saved_tts", "Giọng đã lưu", "voice", "/voice/vault", input_hint="Chọn voice vault."),
